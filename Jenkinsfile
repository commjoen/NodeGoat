  ...
  stages {
        ...
        stage('Integration Testing') {
          steps{
            ...
            sh 'curl http://192.168.1.181:9000/OTHER/core/other/htmlreport/?apikey=dvarh87o132g62dtdst0d5ide7 > secproxy.html'
              archiveArtifacts 'secproxy.html'
            sh 'curl http://192.168.1.181:9000/OTHER/core/other/xmlreport/?apikey=dvarh87o132g62dtdst0d5ide7 > secproxy.xml'
